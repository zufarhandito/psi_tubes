      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-5 mx-auto mt-lg-5 text-center">
            <h1>Wayang Homestay</h1>
            <p class="mb-5"><strong class="text-white">Mantrijeron - Yogyakarta, Indonesia</strong></p>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="owl-carousel slide-one-item with-dots">
              <div><img src="images/wayang1.jpg" alt="Image" class="img-fluid"></div>
              <div><img src="images/property_2.jpg" alt="Image" class="img-fluid"></div>
              <div><img src="images/vanezia.jpg" alt="Image" class="img-fluid"></div>
            </div>
          </div>
          <div class="col-lg-5 pl-lg-5 ml-auto">
            <div class="mb-5">
              ...
              <p><a href="#" class="btn btn-primary">RP.150,000</a></p>
            </div>
