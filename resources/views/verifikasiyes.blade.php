    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/verifikasi">
          ...
          <span >Dashboard Verifikasi</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/verifikasi">List Homestay</a>
          ...
          <div class="col-md-6">
              <div class="card shadow mb-4">
                  ...
                  <div class="card-footer">
                    <form action="/homestay/terima/{{$h->id}}" method="POST">
                      @csrf
                      <button class="btn btn-primary" type="submit">Terima</button>
                    </form>
                 <a class="btn btn-primary" href="/verifikasiyes/hapus/{{ $h->id }}">Tolak</a>
                  </div>
              </div>
          </div>
          @endforeach
